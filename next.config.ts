        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://*.clerk.accounts.dev https://clerk.studyhours.com https://js.clerk.com https://challenges.cloudflare.com https://turnstile.cloudflare.com https://*.daily.co https://www.googletagmanager.com https://www.google-analytics.com https://*.sanity.io https://*.sanity-cdn.com https://sanity-cdn.com https://hcaptcha.com https://*.hcaptcha.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.daily.co https://hcaptcha.com https://*.hcaptcha.com",
              ...
              "connect-src 'self' data: blob: http://localhost:* https://api.razorpay.com https://*.clerk.accounts.dev https://clerk.studyhours.com https://api.clerk.com https://challenges.cloudflare.com https://turnstile.cloudflare.com https://api.studyhours.com wss://api.studyhours.com https://va.vercel-scripts.com https://*.daily.co wss://*.daily.co https://placehold.co https://ipapi.co https://www.google-analytics.com https://*.sentry.io https://ip-api.com https://*.blob.core.windows.net https://*.northflank.app wss://*.northflank.app https://zperiod.studyhours.com https://cellstudio.studyhours.com https://zperiod-alpha.vercel.app https://*.sanity.io https://cdn.sanity.io wss://*.sanity.io https://*.sanity-cdn.com https://sanity-cdn.com https://hcaptcha.com https://*.hcaptcha.com",
              "frame-src 'self' https://checkout.razorpay.com https://api.razorpay.com https://*.clerk.accounts.dev https://clerk.studyhours.com https://challenges.cloudflare.com https://turnstile.cloudflare.com https://*.daily.co https://zperiod.studyhours.com https://cellstudio.studyhours.com https://lab.studyhours.com https://zperiod-alpha.vercel.app https://*.sanity.io https://*.blob.core.windows.net https://hcaptcha.com https://*.hcaptcha.com",
