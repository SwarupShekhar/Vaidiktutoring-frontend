...
> = {
  ...
  "/australia": { priority: 0.8, changeFrequency: "weekly" },
  ...
  "/singapore": { priority: 0.8, changeFrequency: "weekly" },
  ...
  "/uae": { priority: 0.8, changeFrequency: "weekly" },
  "/uae/moe-uae-curriculum-tutors": { priority: 0.85, changeFrequency: "weekly" },
  "/uae/saudi-ministry-curriculum-tutors": { priority: 0.85, changeFrequency: "weekly" },
  ...
  "/uae/online-tutors-riyadh": { priority: 0.8, changeFrequency: "weekly" },
};
