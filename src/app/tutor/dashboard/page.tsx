                      ...
                      {todaySessions.map((session: any) => (
                        ...
                        >
                          ...
                          <div className="flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <button
                              onClick={() => setShareNotesSessionId(session.id)}
                              className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-sm font-black hover:bg-green-200 dark:hover:bg-green-900/50 transition-all active:scale-95"
                            >
                              <FileText size={18} />
                              Share Notes
                            </button>
