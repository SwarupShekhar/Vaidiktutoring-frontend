...
export default function GCSEOnlineTutoringPage({ testimonials }: { testimonials?: any[] }) {
  ...
  return (
    <main className="min-h-screen bg-background transition-colors duration-500 relative selection:bg-sapphire/20 selection:text-sapphire">
      ...
      {/* ============================================
          SECTION 1.1: OUR EXPERT GCSE TUTORS
      ============================================ */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white mb-8 tracking-tighter uppercase leading-none">
                Our Expert GCSE Tutors: Building Foundations That Last
              </h2>
              ...
              <div className="flex flex-wrap gap-3 mb-12">
                {["Exam Board Aligned", "One-on-One Attention", "Long-Term Progress"].map((chip) => (
                  <span
                    key={chip}
            ...
            >
              <Image
                src="https://res.cloudinary.com/de8vvmpip/image/upload/v1770624221/target_uhmfxn.gif"
                alt="Expert GCSE tutors building strong conceptual foundations for student success"
                fill
          ...
          {[
            {
              ...
              desc: "We begin by understanding each student's strengths, weak areas, and learning needs against their specific exam board syllabus.",
            },
            {
              step: "02",
              title: "Personalised Learning Plan",
              desc: "A tailored plan is created around your child's target grades, exam dates, and the topics that need the most attention.",
            },
            {
              step: "03",
              title: "Interactive Live Sessions",
              desc: "Our expert GCSE tutors conduct focused one-on-one sessions built around concept clarity, practice questions, and exam technique.",
            },
            { step: "04", title: "Regular Feedback & Progress Tracking", desc: "Students receive assignments, detailed feedback, and regular progress reports so parents always know exactly where their child stands.", featured: true },
            {
              step: "05",
              title: "Exam Preparation & Confidence Building",
              desc: "Focused past paper practice, mark scheme technique, and revision strategies to build confidence ahead of every assessment.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white mb-8 tracking-tighter uppercase leading-none">
      ...
      <section className="py-24 px-6 bg-surface dark:bg-slate-900/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-none">
            Our GCSE Tutoring & Guidance Programs
          </h2>
          <p className="text-lg font-medium text-text-secondary opacity-70 mb-12">
            Expert tutors available across all major GCSE subjects, aligned to AQA, Edexcel, and OCR syllabuses.
          </p>
        </div>
      ...
      {/* ============================================
          SECTION 6: PERSONALISED TUTORING
      ============================================ */}
      <section className="py-24 px-6 bg-surface dark:bg-slate-900/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-none mb-6">
            Personalised Online GCSE Tutoring
          </h2>
          <p className="text-xl font-medium text-text-secondary opacity-70 max-w-4xl mx-auto">
            Every student learns differently. Our GCSE tutors begin with a full diagnostic assessment to identify exactly where your child is losing marks: then build every session around closing those specific gaps.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "We identify exactly where your child is losing marks and which concepts need immediate attention.",
              icon: Target,
            },
            {
              title: "Personalised Learning Plan", 
              desc: "Built around their specific exam board (AQA, Edexcel, OCR) and individual learning style.",
              icon: LineChart,
            },
            {
              title: "Exam Technique Focus",
              desc: "Beyond content knowledge: we teach how to approach questions like examiners do.",
              icon: Award,
            },
          ].map((item, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="p-10 rounded-4xl bg-white dark:bg-slate-900/50 border border-border dark:border-white/10 shadow-sm hover:shadow-xl transition-all group text-center"
            >
              <div className="w-16 h-16 rounded-2xl bg-sapphire/5 text-sapphire flex items-center justify-center mx-auto mb-8 group-hover:bg-sapphire group-hover:text-white transition-colors">
                <item.icon size={32} />
              </div>
              <h3 className="text-xl font-black text-deep-navy dark:text-white mb-4 tracking-tight leading-tight uppercase italic">
                {item.title}
              </h3>
              <p className="text-text-secondary dark:text-slate-400 font-medium leading-relaxed opacity-80">
                {item.desc}
      ...
      {/* ============================================
          SECTION 7: THE COMPARISON (The Steady Hand)
      ============================================ */}
      ...
      <section className="py-24 px-6 bg-surface dark:bg-slate-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h3 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-none mb-6">
