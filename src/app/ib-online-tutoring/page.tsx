  ...
  const ibFaqs: FAQItemType[] = [
    {
      ...
      a: "We focus on the specific rigors of the IB program, including IA support, TOK guidance, and Extended Essay mentoring, alongside standard subject tutoring.",
    },
    {
    ...
    },
    {
      ...
      a: "Absolutely. Our tutors are specialized in both Standard Level (SL) and Higher Level (HL) requirements for all subjects.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-black text-deep-navy dark:text-white mb-6 tracking-tighter">
              Why IB Students <span className="text-sapphire">Come to Us</span>
            </h2>
            <p className="text-xl text-text-secondary dark:text-slate-400 max-w-2xl mx-auto font-medium">
              We bridge the gap between curriculum demands and student
              confidence.
            </p>
          </div>
