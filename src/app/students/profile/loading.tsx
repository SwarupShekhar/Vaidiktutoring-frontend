...
// StudentProfilePage branches on useIsAppShell() between a dark app-shell
// view and a light web view — mirror that with the same sh_app cookie check
// the dashboard loading.tsx files use.
