...
// StudentVaultPage branches on useIsAppShell() between a dark app-shell view
...
export default async function Loading() {
  ...
  if (isApp) return <AppListSkeleton rows={6} columns={columns} label="Loading vault…" />;
  return <WebListSkeleton rows={6} columns={columns} label="Loading vault…" />;
}
