    ...
    <main className="min-h-screen bg-background transition-colors duration-500 relative selection:bg-primary/20 selection:text-primary">
      ...
      <section className="py-20 md:py-32 px-6 bg-surface dark:bg-background border-y border-border relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-deep-navy dark:text-white mb-20 tracking-tighter">
            Where are you <span className="text-sapphire text-italic italic font-black">right now?</span>
          </h2>
            ...
            {[
              {
                ...
                image: "https://res.cloudinary.com/de8vvmpip/image/upload/v1774000772/Struggling_with_specific_202603201527-Photoroom_idzi2i.png",
                doodles: [
                   { icon: HelpCircle, color: "text-red-400", x: "10%", y: "20%", s: 32 },
                   { icon: Pi, color: "text-sapphire", x: "80%", y: "15%", s: 40 },
                   { icon: Calculator, color: "text-blue-400", x: "15%", y: "70%", s: 34 },
                ]
              },
              {
                ...
                image: "https://res.cloudinary.com/de8vvmpip/image/upload/v1774000874/Exams_in_a_202603201530-Photoroom_wgiefa.png",
                doodles: [
                   { icon: FlaskConical, color: "text-emerald-400", x: "10%", y: "70%", s: 36 },
                   { icon: Atom, color: "text-blue-500", x: "85%", y: "20%", s: 44 },
                   { icon: Sigma, color: "text-amber-400", x: "15%", y: "15%", s: 32 },
                ]
              },
              {
                title: "Aiming for top grades",
                desc: "Needs advanced exam technique mastery for 8/9 grades.",
                cta: "Master Exam Tech",
                image: "https://res.cloudinary.com/de8vvmpip/image/upload/v1774001308/Aiming_for_top_202603201538-Photoroom_yp0d2t.png",
                doodles: [
                   { icon: Star, color: "text-amber-400", x: "10%", y: "15%", s: 40 },
                   { icon: Award, color: "text-sapphire", x: "85%", y: "70%", s: 38 },
                   { icon: TrendingUp, color: "text-primary", x: "80%", y: "10%", s: 34 },
                ]
              },
            ].map((col, i) => (
              <motion.div
                   ...
                   <div className="absolute inset-0 pointer-events-none opacity-20 group-hover:opacity-40 transition-opacity">
                      {col.doodles.map((d, di) => (
                         <motion.div
                            ...
                            transition={{ duration: 3 + di, repeat: Infinity, delay: di * 0.5 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             ...
             <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-2 p-5 bg-sapphire text-white rounded-4xl shadow-2xl max-w-[200px] z-20">
                   <h4 className="text-lg font-black mb-0.5 -tracking-tighter uppercase leading-none">Proven Result.</h4>
             ...
             <div>
                ...
                <h2 className="text-3xl md:text-5xl font-black text-deep-navy dark:text-white mb-8 tracking-tighter leading-tight">
                   Visible <br />
                   <span className="text-sapphire">Transformation.</span>
                </h2>
                
                <div className="space-y-6">
                   {[
                      { without: "Confused by mark schemes", with: "Exam technique built session by session" },
                      { without: "Falling behind on syllabus", with: "Structured catch-up plan from day one" },
                      { without: "Guessing what to revise", with: "Past paper analysis targeting your weak areas" },
                      { without: "Generic online classes", with: "One-on-one expert mentorship" },
                   ].map((row, i) => (
                      <div key={i} className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start group">
                         <div className="p-4 rounded-4xl bg-surface dark:bg-surface/5 border border-border/50 group-hover:border-red-500/30 transition-colors">
                            <span className="text-[7px] font-black text-red-500 uppercase tracking-widest block mb-2 italic">Baseline</span>
                            <p className="text-sm text-text-secondary font-medium opacity-60 leading-tight">{row.without}</p>
                         </div>
                         <div className="p-4 rounded-4xl bg-sapphire/5 border border-sapphire/20 group-hover:bg-sapphire/10 transition-colors">
                            <span className="text-[7px] font-black text-sapphire uppercase tracking-widest block mb-2 italic">Optimized</span>
                            <p className="text-sm text-deep-navy dark:text-white font-black leading-tight">{row.with}</p>
                         </div>
                      </div>
                   ))}
                </div>
      ...
      <section className="py-20 md:py-32 px-6 bg-surface dark:bg-slate-900/50 border-y border-border relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-none">
            Every IGCSE Subject, <span className="text-transparent bg-clip-text bg-linear-to-r from-sapphire to-primary">One Trusted Platform</span>
          </h2>
        </div>

        <div id="subjects" className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           {/* Card 1 — Core Subjects */}
           <SubjectGroup 
            title="Core Subjects" 
            subjects={["IGCSE Mathematics", "IGCSE Additional Maths", "IGCSE English Language", "IGCSE English Literature"]}
          ...
          <SubjectGroup 
            ...
            subjects={["IGCSE Biology", "IGCSE Chemistry", "IGCSE Physics", "IGCSE Combined Science", "Co-ordinated Science (Single & Double Award)", "IGCSE Environmental Management"]}
            icon={FlaskConical}
            isExpandable={true}
            initialShow={3}
          />
          ...
          <SubjectGroup 
            ...
            subjects={["IGCSE Accounting", "IGCSE Business Studies", "IGCSE Economics"]}
            icon={TrendingUp}
          />
          {/* Card 4 — Humanities & Social Sciences */}
          <SubjectGroup 
            title="Humanities & Social Sciences" 
            subjects={["IGCSE History", "IGCSE Geography", "IGCSE Sociology", "IGCSE Global Perspectives"]}
            icon={History}
          />
        ...
        <div className="max-w-7xl mx-auto mt-16 text-center border-t border-border pt-12">
          <p className="text-lg font-black text-deep-navy/60 italic uppercase tracking-tight">
            Don't see your subject? We likely cover it - <Link href="/contact" className="text-sapphire underline underline-offset-4 hover:text-primary transition-colors uppercase">GET IN TOUCH.</Link>
          </p>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto">
             <div className="text-center mb-16 md:mb-24">
                ...
                <h2 className="text-4xl md:text-6xl font-black text-deep-navy dark:text-white mb-8 tracking-tighter">
                  How We Prepare You for <br />
                  <span className="text-emerald-500 underline decoration-2 underline-offset-8 decoration-emerald-500/30">Cambridge Exams.</span>
                </h2>
             </div>

             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                {[
                   { title: "Diagnostic Assessment", desc: "Identify gaps against the Cambridge syllabus.", step: "01" },
                   { title: "Personalised Study Plan", desc: "Built around your specific exam timetable.", step: "02" },
                   { title: "Targeted Sessions", desc: "Concepts, past papers, mark scheme mastery.", step: "03" },
                   { title: "Mock Exams + Feedback", desc: "Timed practice with detailed performance review.", step: "04" },
                ].map((item, i) => (
                   <motion.div 
                      key={i}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
             <div className="max-w-2xl text-left order-2 lg:order-1">
                ...
                <p className="text-xl text-text-secondary dark:text-slate-400 mb-12 font-medium leading-relaxed max-w-xl">
                   Let&apos;s start your revision plan this week. We have tutors ready to focus specifically on the June Cambridge and Edexcel papers.
                </p>
      ...
      ============================================ */}
      <section className="py-40 px-6 bg-[#05010a] relative overflow-hidden transition-colors">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <h2 className="text-4xl sm:text-6xl md:text-7xl font-black text-white mb-8 md:mb-10 tracking-tight leading-none uppercase">
              Every Grade <br />
            ...
            <p className="text-lg md:text-2xl text-slate-400 mb-12 md:mb-16 font-medium leading-relaxed max-w-2xl mx-auto px-4 md:px-0">
               Let&apos;s make sure you earn yours. Join the students securing top results with Cambridge-specialist mentorship.
            </p>
      ...
      <section className="py-24 px-6 bg-background relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl font-bold text-deep-navy dark:text-white mb-6 tracking-normal">Which IGCSE Subjects Do We Cover?</h2>
          <p className="text-sm text-text-secondary dark:text-slate-400 leading-relaxed font-normal opacity-80 max-w-4xl">
            Our tutors provide expert support across all major Cambridge IGCSE subjects. We cover IGCSE Mathematics and IGCSE Additional Maths, alongside IGCSE English Language and IGCSE English Literature. Our science tutors specialise in IGCSE Biology, IGCSE Chemistry, IGCSE Physics, IGCSE Combined Science, and Co-ordinated Science. We also offer tutoring for IGCSE Accounting, IGCSE Business Studies, and IGCSE Economics. Humanities support includes IGCSE History, IGCSE Geography, IGCSE Sociology, and IGCSE Global Perspectives. Technology subjects covered include IGCSE ICT and IGCSE Computer Science. Language support is available for IGCSE French and IGCSE Arabic. Additional subjects include IGCSE Physical Education and Travel & Tourism.
          </p>
        </div>
      </section>
