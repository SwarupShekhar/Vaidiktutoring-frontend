            ...
            <div className="relative">
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {["Maths", "Physics", "English", "Business"].map((s) => (
                    <span
                      key={s}
      ...
      <section className="py-24 px-6 bg-background relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl font-bold text-deep-navy dark:text-white mb-6 tracking-normal">
            Which IGCSE Subjects Do We Cover?
          </h2>
          <p className="text-sm text-text-secondary dark:text-slate-400 leading-relaxed font-normal opacity-80 max-w-4xl">
            Our tutors provide expert support across all major Cambridge IGCSE
            subjects. We cover IGCSE Mathematics and IGCSE Additional Maths,
            alongside IGCSE English Language and IGCSE English Literature. Our
            science tutors specialise in IGCSE Biology, IGCSE Chemistry, IGCSE
            Physics, IGCSE Combined Science, and Co-ordinated Science. We also
            offer tutoring for IGCSE Accounting, IGCSE Business Studies, and
            IGCSE Economics. Humanities support includes IGCSE History, IGCSE
            Geography, IGCSE Sociology, and IGCSE Global Perspectives.
            Technology subjects covered include IGCSE ICT and IGCSE Computer
            Science. Language support is available for IGCSE French and IGCSE
            Arabic. Additional subjects include IGCSE Physical Education and
            Travel & Tourism.
          </p>
        </div>
      </section>
