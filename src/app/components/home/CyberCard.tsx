...
const StyledWrapper = styled.div`
  ...
  /* Dark mode specific override if needed, but variables handle it usually. */
  /* For specific glow visibility on light mode, we might want slightly stronger borders or shadows. */
  ...
  /* Glows - kept mostly same but ensure they overlay correctly */
  .glowing-elements {
    position: absolute;
    inset: 0;
    pointer-events: none;
