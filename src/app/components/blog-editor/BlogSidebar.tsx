...
import { 
  Type, Tag, Folder, Clock, FileText, Search, AlertCircle
} from 'lucide-react';
      ...
      <div className="grid grid-cols-1 gap-3">
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <label className="text-xs font-bold text-text-secondary uppercase tracking-wider">Cover Image</label>
          </div>
          <input
            type="url"
            value={imageUrl}
        ...
        <motion.div 
          className="p-4 rounded-xl bg-gradient-to-br from-primary/10 to-sapphire/10 border border-primary/20 dark:border-white/10 backdrop-blur-md"
          whileHover={{ scale: 1.01 }}
          transition={{ duration: 0.2 }}
        >
          <button 
