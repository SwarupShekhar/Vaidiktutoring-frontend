    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="relative p-2 rounded-full hover:bg-surface transition-all text-text-secondary hover:text-primary"
            >
                {/* Bell Icon */}
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 md:w-96 bg-white dark:bg-[#1a1b26] rounded-2xl shadow-xl border border-border overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-150">
