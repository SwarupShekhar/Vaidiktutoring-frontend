...
export default function ActiveSessionsMonitor() {
    ...
    return (
        <div className="bg-glass rounded-3xl p-6 border-2 border-green-500/20 shadow-lg animate-in fade-in zoom-in-95 duration-500">
            <h2 className="text-xl font-black text-(--color-text-primary) mb-4 flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {sessions.map((session) => (
                    <div key={session.id} className="p-4 rounded-2xl bg-white/40 border border-white/40 hover:border-green-400 transition-all flex flex-col gap-3">
