    ...
    return (
        <section className="mt-32 mb-24 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center p-10 rounded-3xl bg-surface border border-border shadow-xl shadow-blue-900/5 hover:-translate-y-2 transition-transform duration-300">
