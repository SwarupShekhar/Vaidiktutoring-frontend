  ...
  async function onSubmit(values: CreateStudentForm) {
    ...
    try {
      await api.post("/students", {
        ...
        interests: values.interests_raw
          ? values.interests_raw
              .split(",")
              .map((i) => i.trim())
              .filter(Boolean)
          : [],
        recent_focus: values.recent_focus || "",
        struggle_areas: values.struggle_areas_raw
          ? values.struggle_areas_raw
              .split(",")
              .map((i) => i.trim())
              .filter(Boolean)
          : [],
    ...
    <ProtectedClient roles={["parent"]}>
      <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 p-6">
        ...
        <div className="relative z-10 w-full max-w-2xl">
          <div className="bg-white/80 dark:bg-black/60 backdrop-blur-2xl border border-white/50 dark:border-white/10 rounded-4xl shadow-2xl p-8 md:p-10">
            <div className="mb-8 text-center">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                Add your child
              </h1>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Tell us about your child so we can personalize their learning
                experience.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-white/5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all font-medium"
                    placeholder="Alex"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-white/5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all appearance-none font-medium"
                  >
              ...
              <div className="pt-4 flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="flex-1 px-8 py-4 rounded-xl bg-linear-to-r from-blue-600 to-indigo-600 text-white font-black hover:opacity-90 transition-all shadow-xl shadow-blue-500/20 disabled:opacity-70 disabled:cursor-not-allowed uppercase text-xs tracking-widest"
                >
