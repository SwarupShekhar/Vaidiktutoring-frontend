    ...
    return (
        <div className="min-h-screen bg-background py-10 transition-colors duration-300">
            <div className="max-w-3xl mx-auto px-6">
                <h1 className="text-3xl font-semibold text-(--color-text-primary) mb-2">
                    Add your child
                </h1>
                ...
                <Suspense
                    fallback={
                        <div className="flex items-center justify-center p-8 bg-surface rounded-2xl border border-border">
