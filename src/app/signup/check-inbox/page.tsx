            ...
            <div className="relative z-10 w-full max-w-lg">
                <div className="bg-white/60 dark:bg-black/60 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-3xl shadow-2xl p-8 text-center space-y-6">
                    ...
                    <div className="pt-6">
                        <Link
                            href="/login"
                            className="inline-flex items-center justify-center rounded-xl bg-primary px-8 py-3 text-base font-bold text-white shadow-lg hover:opacity-90 hover:-translate-y-0.5 transition-all"
                        >
                            Back to Login
                        </Link>
                    </div>
