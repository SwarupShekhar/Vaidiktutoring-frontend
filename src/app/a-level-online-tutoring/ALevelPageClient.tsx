    ...
    <main className="min-h-screen bg-background transition-colors duration-500 relative selection:bg-sapphire/20 selection:text-sapphire">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              <Image
                ...
                alt="Expert online A-Level tutor working one-on-one with a student on A-Level exam preparation | StudyHours"
                fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {[
              { 
                ...
                desc: "Our private A-Level tutors understand the pressure of predicted grades and conditional offers — and build every session around them.",
                icon: "https://res.cloudinary.com/de8vvmpip/image/upload/v1770624221/target_uhmfxn.gif"
              },
              { 
                title: "Deep Subject Expertise", 
                desc: "Our online A-Level tutors specialise in specific subjects — not generalists who cover everything loosely.",
      ...
      <section className="py-24 px-6 bg-background relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 text-center mb-24">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-deep-navy dark:text-white mb-8 tracking-tighter">
            What Expert A-Level Tutoring <br />
            <span className="text-sapphire">Builds in Every Student</span>
          </h2>
      ...
      <section className="py-24 px-6 bg-surface dark:bg-slate-900/50 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10 text-center mb-20">
           ...
           <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-none mb-6">
              How Our Private A-Level Tutors <span className="text-sapphire italic">Support You — Start to Finish</span>
           </h2>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1 space-y-4">
            {[
              ...
              { step: "02", title: "Matched with a Subject Specialist", desc: "Paired with a specialist online A-Level tutor who knows your exact syllabus and exam board inside out." },
          ...
          >
            <Image 
              ...
              alt="A-Level study materials and annotated notes used in online A-Level tutoring sessions | StudyHours"
              fill
              sizes="(max-width: 768px) 100vw, 50vw"
      ...
      <section className="py-24 md:py-40 px-6 bg-background relative overflow-hidden border-y border-border">
        <div className="max-w-7xl mx-auto relative z-10 text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-none">
            Online A-Level Tutoring <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-sapphire to-primary">Across Every Subject & Exam Board</span>
          </h2>
        </div>
      ...
      <section className="py-16 px-6 bg-surface border-y border-border">
         <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-md">
              <h2 className="text-2xl font-black text-deep-navy dark:text-white uppercase tracking-tighter leading-none mb-2">Our A-Level Tutors Online <br /> <span className="text-sapphire">Cover Every Major Exam Board.</span></h2>
              <p className="text-sm font-medium text-text-secondary">Every online A-Level tutor on our platform is matched to your specific board and syllabus — AQA, Edexcel, OCR, or Cambridge International.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="relative h-[400px] lg:h-auto overflow-hidden">
                <Image 
                  ...
                  alt="Private A-Level tutor student focused on structured revision for A-Level exams | StudyHours" 
                  fill 
                  sizes="(max-width: 768px) 100vw, 50vw"
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-16 px-6">
            <h2 className="text-4xl md:text-5xl font-black text-deep-navy dark:text-white tracking-tighter uppercase leading-tight">
              Common Questions About Our <span className="text-sapphire italic">Online A-Level Tutors</span>
            </h2>
          </div>
      ...
      <section className="py-24 px-6 bg-background relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl font-bold text-deep-navy dark:text-white mb-6 tracking-normal">Find Expert Online A-Level Tutors for Every Subject</h2>
          <p className="text-sm text-text-secondary dark:text-slate-400 leading-relaxed font-normal opacity-80 max-w-4xl">
            StudyHours connects students with expert online A-Level tutors
            across all major subjects. Whether you need private A-Level tutors
            for core sciences, humanities, languages, or practical subjects,
            our specialist tutors provide structured one-on-one A-Level
            tuition aligned to your exam board. Our A-Level tutors online
            cover AQA, Edexcel, OCR, and Cambridge International across
            subjects including A-Level Maths, A-Level Further Maths, A-Level
            English, A-Level Biology, A-Level Chemistry, A-Level Physics, and
            A-Level Psychology. Humanities and social sciences A-Level
            tutoring is available for Geography, History, Economics, Business,
            Religious Studies, Politics, Philosophy, Classics, Latin, and
            Greek. Online A-Level tutoring for practical subjects includes
            Computer Science, Music, Design Technology, Art, and Drama.
            Language A-Level tuition covers French, Spanish, German, Chinese,
            and Italian. Every online A-Level tutor is vetted,
            subject-specialist, and matched to your specific syllabus and
            target grade.
          </p>
        </div>
      </section>
